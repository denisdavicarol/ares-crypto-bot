...
print(f"DEBUG: Chave API Carregada: {'Sim, encontrada!' if API_KEY else 'NAO ENCONTRADA'}")
print(f"DEBUG: Chave Secreta Carregada: {'Sim, encontrada!' if API_SECRET else 'NAO ENCONTRADA'}")
